<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="event6.aspx.cs" Inherits="TM_Application.WebForms.event6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-5">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <img src="<%= ResolveUrl("~/Resources/event6.jpg") %>" class="img-fluid" alt="All Black">
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-md-8">
                <h1>Beach View Musical Event</h1>
                <p><strong>Date:</strong> March 25, 2025</p>
                <p><strong>Location:</strong> 137 Marine Parade, Durban Central, Durban, 4001</p>
                <p>
                  Enjoy our deep, and smooth music with also our lovely beach view.
                </p>
